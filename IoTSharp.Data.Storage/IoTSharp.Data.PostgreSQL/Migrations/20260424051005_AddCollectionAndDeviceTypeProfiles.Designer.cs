...
namespace IoTSharp.Data.PostgreSQL.Migrations
{
    ...
    [Migration("20260424051005_AddCollectionAndDeviceTypeProfiles")]
    partial class AddCollectionAndDeviceTypeProfiles
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("IoTSharp.Data.CollectionDevice", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.Property<string>("ProtocolOptionsJson")
                        .HasColumnType("text");
                    ...
                    b.HasIndex("TaskId", "SlaveId")
                        .IsUnique();

                    b.ToTable("CollectionDevices", (string)null);
                });

            modelBuilder.Entity("IoTSharp.Data.CollectionLog", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.Property<string>("RequestFrame")
                        .HasColumnType("text");
                    ...
                    b.Property<string>("ResponseFrame")
                        .HasColumnType("text");
                    ...
                    b.HasIndex("GatewayDeviceId");

                    b.HasIndex("RequestId");

                    b.HasIndex("Status");

                    b.HasIndex("GatewayDeviceId", "CreatedAt");

                    b.ToTable("CollectionLogs", (string)null);
                });

            modelBuilder.Entity("IoTSharp.Data.CollectionPoint", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.Property<string>("PollingGroup")
                        .HasMaxLength(50)
                        .HasColumnType("character varying(50)");
                    ...
                    b.Property<string>("TargetValueType")
                        .ValueGeneratedOnAdd()
                        .HasMaxLength(50)
                        .HasColumnType("character varying(50)")
                    ...
                    b.HasIndex("DeviceId", "Address", "FunctionCode")
                        .IsUnique();

                    b.ToTable("CollectionPoints", (string)null);
                });

            modelBuilder.Entity("IoTSharp.Data.CollectionRuleTemplate", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("CollectionRuleTemplates", (string)null);
                });

            modelBuilder.Entity("IoTSharp.Data.CollectionTask", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.Property<string>("ReportPolicyJson")
                        .HasColumnType("text");
                    ...
                    b.ToTable("CollectionTasks", (string)null);
                });
            ...
            modelBuilder.Entity("IoTSharp.Data.Device", b =>
                {
                    ...
                    b.Property<Guid?>("DeviceTypeProfileId")
                        .HasColumnType("uuid");

                    b.Property<int?>("HvacDeviceType")
                        .HasColumnType("integer");
                    ...
                    b.HasIndex("DeviceTypeProfileId");
            ...
            modelBuilder.Entity("IoTSharp.Data.DeviceTypeProfile", b =>
                {
                    ...
                    b.ToTable("DeviceTypeProfiles", (string)null);
                });
            ...
            modelBuilder.Entity("IoTSharp.Data.CollectionDevice", b =>
                {
                    b.HasOne("IoTSharp.Data.CollectionTask", "Task")
                        .WithMany("Devices")
            ...
            modelBuilder.Entity("IoTSharp.Data.CollectionPoint", b =>
                {
                    b.HasOne("IoTSharp.Data.CollectionDevice", "Device")
                        .WithMany("Points")
                        .HasForeignKey("DeviceId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("IoTSharp.Data.Device", "TargetDevice")
                        .WithMany()
            ...
            modelBuilder.Entity("IoTSharp.Data.CollectionRuleTemplate", b =>
                {
                    b.HasOne("IoTSharp.Data.DeviceTypeProfile", "Profile")
            ...
            modelBuilder.Entity("IoTSharp.Data.CollectionTask", b =>
                {
                    b.HasOne("IoTSharp.Data.Gateway", "GatewayDevice")
                        .WithMany()
                        .HasForeignKey("GatewayDeviceId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("GatewayDevice");
                });
            ...
            modelBuilder.Entity("IoTSharp.Data.Device", b =>
                {
                    ...
                    b.HasOne("IoTSharp.Data.DeviceTypeProfile", "DeviceTypeProfile")
                        .WithMany("Devices")
                        .HasForeignKey("DeviceTypeProfileId");
                    ...
                    b.Navigation("DeviceTypeProfile");
